...
export const findCorrectionKeyword = (text = '') => {
  ...
  // 1. Check pre-compiled keyword patterns, finding the earliest occurrence
...
/**
 * Cleans extracted text fragment.
 * @param {string} phrase 
 * @returns {string|null}
 */
...
/**
 * Extracts raw text fragment ('fromText') preceding the correction.
 * @param {string} text 
 * @param {string} keyword 
...
/**
 * Extracts raw text fragment ('toText') following the correction.
 * @param {string} text 
 * @param {string} keyword 
 * @param {number} keywordIndex 
 * @returns {string|null}
...
export const detectCorrection = (interaction) => {
  ...
  // Pure evidence enrichment: push to corrections list only
