...
/**
 * Derives domain for an extracted constraint value using word boundary regex matching.
 * @param {string} value 
 * @returns {string} (framework | theme | style | database | feature | budget | general)
 */
...
/**
 * Cleans extracted text fragment, stripping punctuation and leading prepositions.
 * @param {string} phrase 
 * @returns {string|null}
 */
...
/**
 * Parses numeric limit values and units, dynamically inferring limit domain.
 * @param {string} rawVal 
 * @param {string} rawUnit 
 * @returns {{ value: number, operator: string, unit: string|null, domain: string }}
 */
const parseLimitDetails = (rawVal = '', rawUnit = '') => {
  ...
  // TODO: Add full operator parsing (e.g. >= for "at least", == for "exactly") in future iteration
  return {
 ...
 * // TODO: Replace/enhance with LLM semantic constraint detector in future iterations.
 * 
